$(document).ready(function() {
    ...
    function switchCheck(moveId) {
        ...
        switch (moveId) {
            ...
            case 1:
                ...
                //alert(twop.length)
                var speed = [0,1000,1800,2500,3000]
                for (var i = 0; i < twop.length; i++) {
                    $(twop[i]).fadeIn(speed[i]);
                }
            ...
            case 2:
                ...
                var speed = [0,1000,1800,2500,1800,1000]
                for (var i = 0; i < threeLi.length; i++) {
                    $(threeLi[i]).fadeIn(speed[i]);
                }
                $(".page-four-top").fadeOut();
                $("hr").animate({
                    marginLeft: "-1200px"
                }, "50000", function() {
                    $(".page-four-bottom").animate({
                        marginLeft: "1000px"
                    }, "slow")
                });
                break;
    ...
    $("#bth li").find("a").on("click", function() {
